...
namespace ByteBank
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double saldo;
            ContaCorrente contaCorrente1 = new ContaCorrente(123, 132, cliente1);
            do{
            ...
            contaCorrente._Saldo = saldo;

            Console.WriteLine("ByteBank - Deposito");
            Cliente usuario = contaCorrente._Titular;
            Console.WriteLine($"Bem vindo - {usuario._Nome}");
            Console.WriteLine($"Agencia: {contaCorrente._Agencia}   Conta: {contaCorrente._Numero}");
            ...
            Console.WriteLine($"Saldo atual: {contaCorrente._Saldo}");
            Console.WriteLine();
            ...
            Console.WriteLine($"Bem vindo - {usuario._Nome}");
            Console.WriteLine($"Agencia: {contaCorrente._Agencia}   Conta: {contaCorrente._Numero}");
            Console.WriteLine($"Saldo origem: {contaCorrente._Saldo}");
            Console.WriteLine($"Saldo destino: {contaCorrente2._Saldo}");
